...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/ ([
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            exports.postProcessText = exports.putFont = void 0;
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var jsPDF = _interopRequireWildcard(__webpack_require__(2));
            
            var _ttffont = _interopRequireDefault(__webpack_require__(1));
            
            var _ttfsupport = __webpack_require__(0);
            ...
            jsPDF.API.events.push(['addFont', function (font) {
                ...
                if (jsPDF.API.existsFileInVFS(postScriptName)) {
                    ...
                    console.error("Font does not exist in FileInVFS, import fonts or remove declaration doc.addFont('".concat(postScriptName, "')."));
                }
            }]);
            jsPDF.API.events.push(['putFont', _ttfsupport.putFont]);
            jsPDF.API.events.push(['postProcessText', _ttfsupport.postProcessText]);
